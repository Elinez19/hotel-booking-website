...
const featuredHotels = [
  ...
  },
  {
    ...
    price: 199,
    image:
      "https://images.pexels.com/photos/1458457/pexels-photo-1458457.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
...
const destinations = [
  {
    ...
    count: 125,
    image:
      "https://images.pexels.com/photos/802024/pexels-photo-802024.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
    slug: "new-york",
  },
  {
    name: "Paris",
  ...
  },
  {
    ...
    count: 112,
    image:
      "https://images.pexels.com/photos/2506923/pexels-photo-2506923.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
    slug: "tokyo",
  },
  {
    name: "Bali",
...
const testimonials = [
  {
    ...
    rating: 5,
    comment:
      "The best hotel booking experience I've ever had. The room was exactly as pictured and the staff was incredibly accommodating.",
    image:
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Luxstay made our honeymoon unforgettable. We got a free upgrade and the concierge service was exceptional.",
    image:
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Great selection of luxury hotels at reasonable prices. Will definitely use this service again for my next trip.",
    image:
    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.pexels.com/photos/258154/pexels-photo-258154.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940')",
          }}
        >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-wrap items-center ml-36 mt-10">
            <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
              <div className="pt-32 sm:pt-0">
                ...
                <p className="text-white opacity-80 text-lg mb-12 leading-relaxed">
                  Discover handpicked hotels, exclusive amenities, and
                  personalized service. Your perfect getaway is just a few
                  clicks away.
                </p>
                <div className="flex gap-4">
                  ...
                  <a
                    href="#how-it-works"
                    className="bg-transparent text-white border border-white font-medium px-6 py-3 rounded-md hover:bg-white/10 transition-colors"
                  >
                    How It Works
                  </a>
                </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              From luxury suites and boutique hotels to cozy villas and
              apartments, find the perfect accommodation type for your next
              journey.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="max-w-3xl mx-auto text-gray-300">
              We're dedicated to providing you with the best booking experience
              possible, with personalized service and attention to every detail.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Every property is handpicked and quality-checked to ensure your
                satisfaction.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Multiple payment options and free cancellation on most rooms for
                your convenience.
              </p>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Explore our most sought-after destinations and find your next
              dream getaway
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="mb-8 lg:mb-0 lg:w-1/2">
              ...
              <p className="text-white/80 max-w-lg">
                ...
                special promotions, new destinations, and travel tips.
              </p>
            </div>
